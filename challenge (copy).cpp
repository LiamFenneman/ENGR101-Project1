...
int main(){
    ...
    for (int i = 0; i < n_samples; ++i) {
        ...
        int currentNote = (int)(i / (float)(sample_rate * note_duration));	// get the current note to be played
        float f = notes[currentNote];	// get freq. from note score sheet
        
        //float note_t = t / (float)noteCount;
